...
line_shape_rectangle::line_shape_rectangle(const float x, const float y, const float z)
{
...
line_shape_rectangle::~line_shape_rectangle()
{
    entity::~entity();
...
void line_shape_rectangle::init_buffers()
{
...
void line_shape_rectangle::render()
{
